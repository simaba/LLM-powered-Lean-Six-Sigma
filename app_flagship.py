...
st.markdown('<div class="hero-card"><h3 style="margin:0;">Guide the assessment. Review the evidence. Refine the plan.</h3><div class="small-muted" style="color:#dbeafe;">This flagship version uses a step-by-step flow so non-technical users can validate outputs instead of just reading them.</div></div>', unsafe_allow_html=True)
